globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/PropShell-C8iRySyN.js","assets/ThemeSwitcher-dBiEeeuI.js","assets/lock-keyhole-DFumPEOa.js","assets/page-BwyWi2N-.js","assets/page-C3UEYDLH.js","assets/page-BlRo6-12.js","assets/layout-segment-context-BS9FcUZU.js","assets/router-BARmFxQO.js"];
...
function getDraftSecret() {
	return "4c4ab2cc-a2d0-4790-9820-f67c0e5a2a20";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "ec7fed97-c7a1-497f-b8fe-5308fe6a8316";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "ec7fed97-c7a1-497f-b8fe-5308fe6a8316") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "ec7fed97-c7a1-497f-b8fe-5308fe6a8316",
		rootBoundaryId
	});
}
/**
...
var metadata = {
	...
	description: "A focused trading workspace for managing your PropFirm account, risk limits, positions, and profile.",
	openGraph: {
		...
		images: [{
			...
			width: 1732,
			height: 920,
			alt: "PropFirm trading workspace"
		}]
	},
	twitter: {
