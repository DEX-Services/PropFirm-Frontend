...
var client_references_default = {
	"15c18cfaeeff": async () => {
		const m = await import("./assets/layout-segment-context-zX-SgzFr.js");
		return { get "LayoutSegmentProvider"() {
			return m["LayoutSegmentProvider"];
		} };
	},
	"593f344dc510": async () => {
		const m = await import("./assets/error-boundary-QULruV8Z.js");
		return {
			get "ErrorBoundary"() {
	...
	"6efdf509a785": async () => {
		const m = await import("./assets/page-D5Mpzug7.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	...
	"b5f72a92d407": async () => {
		const m = await import("./assets/page-D365UnG-.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"c6e7975ddabc": async () => {
		const m = await import("./assets/page-DLEGcjj0.js");
		return { get "default"() {
			return m["default"];
		} };
	}
