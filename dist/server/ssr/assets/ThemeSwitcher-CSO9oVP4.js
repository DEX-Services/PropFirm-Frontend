...
__iconData$3.node;
var ShieldCheck = createLucideIcon(__iconData$3);
//#endregion
...
var Link = (0, import_react.forwardRef)(function Link({ href, as, replace = false, prefetch: prefetchProp, scroll = true, children, onClick, onMouseEnter, onTouchStart, onNavigate, ...rest }, forwardedRef) {
	...
	const handleClick = async (e) => {
		...
		if (typeof window.__VINEXT_RSC_NAVIGATE__ === "function") {
			...
			const Router = (await import("./router-OkaFjg5F.js")).default;
...
__iconData$2.node;
var Moon = createLucideIcon(__iconData$2);
//#endregion
...
__iconData$1.node;
var Palette = createLucideIcon(__iconData$1);
//#endregion
...
//#endregion
//#region app/components/ThemeSwitcher.tsx
var options = [
	{
		value: "dark",
		label: "Dark",
...
function ThemeSwitcher({ compact = false }) {
	...
	(0, import_react.useEffect)(() => {
		...
		window.dispatchEvent(new CustomEvent("propfirm-theme-change", { detail: theme }));
	}, [theme]);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: options.map((option) => {
			...
			return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, { size: 14 }), !compact && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: option.label })]
			}, option.value);
		})
	});
}
//#endregion
export { urlQueryToSearchParams as a, ShieldCheck as c, appendSearchParamsToUrl as i, createLucideIcon as l, Link as n, addLocalePrefix as o, addQueryParam as r, getDomainLocaleUrl as s, ThemeSwitcher as t };
