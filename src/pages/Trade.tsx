    ...
    <AppShell isTradePage>
      <div className="h-[calc(100vh-3.5rem)] flex flex-col gap-2 p-2 overflow-hidden">
        ...
        <PanelGroup direction="horizontal" className="flex-1 min-h-0">
          <Panel ref={leftPanelRef} defaultSize={DEFAULT_COL_SIZES[0]} minSize={collapsed ? 3 : 12} maxSize={35}>
          ...
          <Panel ref={centerPanelRef} defaultSize={DEFAULT_COL_SIZES[1]} minSize={25}>
            <PanelGroup direction="vertical" className="h-full">
              ...
              <Panel ref={posPanelRef} defaultSize={DEFAULT_CENTER_SIZES[1]} minSize={12}>
                <PanelCard title="Positions">
                  <PositionsPanel
          ...
          <Panel ref={rightPanelRef} defaultSize={DEFAULT_COL_SIZES[2]} minSize={16} maxSize={34}>
            <PanelGroup direction="vertical" className="h-full">
              ...
              <Panel defaultSize={40} minSize={18}>
                <OrderBookPanel selected={selected} />
              </Panel>
            </PanelGroup>
          </Panel>
        </PanelGroup>
